...
export function GameUI({
  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-end text-white z-[100] pointer-events-none">

      {/* Content Area - Only active if not on Play tab */}
      <main className={cn(
        ...
        activeTab === 'play' ? "translate-y-full opacity-0 pointer-events-none" : "translate-y-0 opacity-100 bg-black/95 backdrop-blur-3xl"
      )}>

        {activeTab === 'inventory' && (
          <div className="w-full max-w-md space-y-8">
            <h2 className="text-5xl font-black italic tracking-tighter uppercase text-center">Skins</h2>
        ...
        {activeTab === 'store' && (
          <div className="w-full max-w-md space-y-8 text-center">
            <h2 className="text-5xl font-black italic tracking-tighter uppercase text-yellow-400">Shop</h2>
        ...
        {activeTab === 'event' && (
          <div className="w-full max-w-md space-y-8 pb-12 text-center">
            <h2 className="text-5xl font-black italic tracking-tighter uppercase text-blue-400">Win</h2>
